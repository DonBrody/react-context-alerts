...
var createHeader = function createHeader(text, style) {
...
var createMessage = function createMessage(text, style) {
...
var createBodyWrapper = function createBodyWrapper(header, message, style) {
...
var createAdornmentWrapper = function createAdornmentWrapper(child, style) {
...
var createActionWrapper = function createActionWrapper(child, style) {
...
var createActionButton = function createActionButton(text, onClick, style) {
