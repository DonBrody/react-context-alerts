...
function (_Component) {
  ...
  function Alert() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "bodyContent", function (header, message) {
      ...
      return content(theme[type].body.header(header), theme[type].body.message(message), _this.bodyContentStyles());
    });
    ...
    value: function () {
      function componentDidMount() {
        ...
        var _this$props11 = this.props,
            ...
            settings = _this$props11.settings;
    ...
    value: function () {
      function render() {
        ...
        var _this$props12 = this.props,
            ...
            header = _this$props12.header,
            message = _this$props12.message,
            settings = _this$props12.settings;
        ...
        }, this.showClose(settings) && this.closeWrapper(this.onClose)))))));
      }
