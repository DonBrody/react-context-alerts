...
function (_Component) {
  ...
  function Alert() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clearCurrentTimeout", function () {
      var timeoutFunction = _this.state.timeoutFunction;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "bodyStyles", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "bodyWrapper", function (header, message) {
      ...
      return wrapper(theme[type].body.header(header), theme[type].body.message(message), _this.bodyStyles());
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "actionWrapper", function (text, onClick) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "closeButtonStyles", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "actionButtonColumns", function (settings) {
      return settings.showActionButton && settings.actionText && settings.actionClickListener ? 3 : false;
    });
  ...
  _createClass(Alert, [{
    ...
    value: function () {
      function render() {
        ...
        var showAdornment = settings.showAdornment,
            showActionButton = settings.showActionButton,
            showCloseButton = settings.showCloseButton,
            actionText = settings.actionText,
            actionClickListener = settings.actionClickListener;
        ...
        }, showAdornment && this.adornmentWrapper()), _react["default"].createElement(_core.Grid, {
          item: true,
        ...
        }, showActionButton && actionText && actionClickListener && this.actionWrapper(actionText, actionClickListener)), _react["default"].createElement(_core.Grid, {
          item: true,
          xs: this.closeButtonColumns(settings)
        }, showCloseButton && _react["default"].createElement(_core.IconButton, {
