...
/*#__PURE__*/
function (_Component) {
  _inherits(AlertController, _Component);
  ...
  function AlertController() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AlertController)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
_defineProperty(AlertController, "determineValue", function (globalValue, typeValue) {
...
_defineProperty(AlertController, "settingValue", function (key, type, settings) {
...
;
AlertController.propTypes = process.env.NODE_ENV !== "production" ? {
