...
function (_Component) {
  ...
  function AlertsProvider(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AlertsProvider).call(this, props));
    _this.state = DEFAULT_STATE;
    _this.createAlertObject = _this.createAlertObject.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onAlertClose = _this.onAlertClose.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(AlertsProvider, [{
    key: "createAlertObject",
    value: function () {
      function createAlertObject(type, header, message) {
        return {
          id: count++,
          type: type,
          header: header,
    ...
    key: "onAlertClose",
    value: function () {
      function onAlertClose(alert) {
        this.setState({
          alerts: this.state.alerts.filter(function (current) {
    ...
    value: function () {
      function render() {
        ...
        }, this.props.children, _react["default"].createElement("aside", {
