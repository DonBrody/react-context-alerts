...
function (_Component) {
  ...
  function AlertsProvider() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createAlertObject", function (type, header, message, callback, instanceSettings) {
      return {
        id: count++,
        type: type,
        header: header,
          ...
          value: {
            info: function () {
              function info(header, message) {
                ...
                _this2.setState({
                  alerts: [].concat(_toConsumableArray(_this2.state.alerts), [info])
                });
              }
            ...
            success: function () {
              function success(header, message) {
                ...
                _this2.setState({
                  alerts: [].concat(_toConsumableArray(_this2.state.alerts), [success])
                });
              }
            ...
            warning: function () {
              function warning(header, message) {
                ...
                _this2.setState({
                  alerts: [].concat(_toConsumableArray(_this2.state.alerts), [warning])
                });
              }
            ...
            error: function () {
              function error(header, message) {
                ...
                _this2.setState({
                  alerts: [].concat(_toConsumableArray(_this2.state.alerts), [error])
                });
              }
