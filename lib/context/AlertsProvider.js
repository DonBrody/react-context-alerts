          ...
          value: {
            ...
            info: function () {
              function info(header, message) {
                ...
                var info = _this2.createAlertObject('info', header, message, settings);
            ...
            success: function () {
              function success(header, message) {
                ...
                var success = _this2.createAlertObject('success', header, message, settings);
            ...
            warning: function () {
              function warning(header, message) {
                ...
                var warning = _this2.createAlertObject('warning', header, message, settings);
            ...
            error: function () {
              function error(header, message) {
                ...
                var error = _this2.createAlertObject('error', header, message, settings);
