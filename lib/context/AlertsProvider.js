...
function (_Component) {
  ...
  function AlertsProvider() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onThemePropsUpdated", function (prevTheme, theme) {
      if (theme !== prevTheme) {
        _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSettingsPropsUpdated", function (prevSettings, settings) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createAlertObject", function (type, header, message, instanceSettings) {
      return {
        id: count++,
        type: type,
        header: header,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createCustomTheme", function (overrides) {
      return (0, _createRcaTheme["default"])(overrides, _this.state.theme);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createCustomSettings", function (overrides) {
    ...
    value: function () {
      function render() {
        ...
        return _react["default"].createElement(AlertsContext.Provider, {
          value: {
            ...
            info: function () {
              function info(header, message) {
                ...
                var info = _this2.createAlertObject(_types["default"].info, header, message, settings);
            ...
            success: function () {
              function success(header, message) {
                ...
                var success = _this2.createAlertObject(_types["default"].success, header, message, settings);
            ...
            warning: function () {
              function warning(header, message) {
                ...
                var warning = _this2.createAlertObject(_types["default"].warning, header, message, settings);
            ...
            error: function () {
              function error(header, message) {
                ...
                var error = _this2.createAlertObject(_types["default"].error, header, message, settings);
          ...
          style: _objectSpread({}, defaultStyles, this.props.style)
